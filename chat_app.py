...
from config import LOGOUT_BUTTON_STYLE, AUTH_CONTAINER_STYLE, BAT_DATA, DEFAULT_QUERY, DEFAULT_FINAL_RESPONSE, ERROR_MESSAGE, BAT_LOGO_PATH, CMS_LOGO_PATH
...
display_images(BAT_LOGO_PATH, CMS_LOGO_PATH)
